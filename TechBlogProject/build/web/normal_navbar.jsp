<nav class="navbar navbar-expand-lg navbar-dark primary-background">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="nav-link  text-white" href="login_page.jsp"><span class="fa fa-user-circle-o"></span> Login</a>
            </li>
            <li class="nav-item">
                <a class="nav-link  text-white" href="register_page.jsp"><span class="fa fa-user-plus"></span> Sign up</a>
            </li>
        </ul>
